...
<html>
  <head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('application/css/animate.css') ?>">
    <link rel="stylesheet" href="<?php echo base_url('application/css/owl.carousel.min.css') ?>">
    <link rel="stylesheet" href="<?php echo base_url('application/css/aos.css') ?>">
    <link rel="stylesheet" href="<?php echo base_url('application/css/bootstrap-datepicker.css') ?>">
    <link rel="stylesheet" href="<?php echo base_url('application/css/jquery.timepicker.css') ?>">
    <link rel="stylesheet" href="<?php echo base_url('application/css/fancybox.min.css') ?>">
    
    <link rel="stylesheet" href="<?php echo base_url('application/css/fonts/ionicons/css/ionicons.min.css') ?>">
    <link rel="stylesheet" href="<?php echo base_url('application/css/fonts/fontawesome/css/font-awesome.min.css') ?>">
  ...
  <body>
    ...
    <section class="site-hero overlay" style="background-image: url(/meuHotel/imagens/hero_4.jpg)" data-stellar-background-ratio="0.5">
      <div class="container">
        ...
        <div class="row align-items-center">
          <div class="col-md-12 col-lg-7 ml-auto order-lg-2 position-relative mb-5" data-aos="fade-up">
            <figure class="img-absolute">
              <img src="/meuHotel/imagens/food-1.jpg" alt="Image" class="img-fluid">
            </figure>
            <img src="/meuHotel/imagens/img_1.jpg" alt="Image" class="img-fluid rounded">
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4" data-aos="fade-up">
            <a href="#" class="room">
              <figure class="img-wrap">
                <img src="/meuHotel/imagens/img_1.jpg" alt="Free website template" class="img-fluid mb-3">
              </figure>
          ...
          <div class="col-md-6 col-lg-4" data-aos="fade-up">
            <a href="#" class="room">
              <figure class="img-wrap">
                <img src="/meuHotel/imagens/img_2.jpg" alt="Free website template" class="img-fluid mb-3">
              </figure>
              <div class="p-3 text-center room-info">
                <h2>Family Room</h2>
          ...
          <div class="col-md-6 col-lg-4" data-aos="fade-up">
            <a href="#" class="room">
              <figure class="img-wrap">
                <img src="/meuHotel/imagens/img_3.jpg" alt="Free website template" class="img-fluid mb-3">
              </figure>
              <div class="p-3 text-center room-info">
          ...
          <div class="js-carousel-2 owl-carousel mb-5" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="testimonial text-center slider-item">
              <div class="author-image mb-3">
                <img src="/meuHotel/imagens/person_1.jpg" alt="Image placeholder" class="rounded-circle mx-auto">
              </div>
              <blockquote>
            ...
            <div class="testimonial text-center slider-item">
              <div class="author-image mb-3">
                <img src="/meuHotel/imagens/person_2.jpg" alt="Image placeholder" class="rounded-circle mx-auto">
              </div>
              <blockquote>
            ...
            <div class="testimonial text-center slider-item">
              <div class="author-image mb-3">
                <img src="/meuHotel/imagens/person_3.jpg" alt="Image placeholder" class="rounded-circle mx-auto">
              </div>
              <blockquote>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="media media-custom d-block mb-4 h-100">
              <a href="#" class="mb-4 d-block"><img src="../meuHotel/imagens/img_1.jpg" alt="Image placeholder" class="img-fluid"></a>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="200">
            <div class="media media-custom d-block mb-4 h-100">
              <a href="#" class="mb-4 d-block"><img src="/meuHotel/imagens/img_2.jpg" alt="Image placeholder" class="img-fluid"></a>
              <div class="media-body">
                <span class="meta-post">February 26, 2018</span>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="300">
            <div class="media media-custom d-block mb-4 h-100">
              <a href="#" class="mb-4 d-block"><img src="/meuHotel/imagens/img_3.jpg" alt="Image placeholder" class="img-fluid"></a>
              <div class="media-body">
                <span class="meta-post">February 26, 2018</span>
