...
--
-- Host: 127.0.0.1
-- Tempo de geração: 17/05/2024 às 19:28
...
(3, '2024-05-07', '2024-05-14', '2024-05-21', 'F', 1, 1, '0.0000');
...
INSERT INTO `cliente` (`id_cliente`, `nome`, `cpf`, `data_nascimento`, `cep`, `endereco`, `bairro`, `numero`, `cidade`, `uf`, `telefone`, `email`, `senha`) VALUES
(1, 'Augusto', '421.616.278-99', '2004-11-18', '17516740', 'Av. Das esmeraldas', 'Esmeralda', '800', 'Marilia', 'SP', '(14) 9913-04050', 'augusto.valenciano@fabricadecodigos.com.br', '123');
...
--
-- Estrutura para tabela `config_quarto`
--

CREATE TABLE `config_quarto` (
  `id_foto` int(11) NOT NULL,
  `caminho` varchar(100) NOT NULL,
  `id_quarto` int(11) NOT NULL,
  `obs_1` varchar(30) NOT NULL,
  `obs_2` varchar(30) NOT NULL,
  `obs_3` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `foto_quarto` (`id_foto_quarto`, `caminho`, `id_quarto`, `titulo`, `descricao`) VALUES
(1, 'imagem_2024-05-08_110001076.png', 1, 'teste', 'teste'),
(2, 'vagabond-by-the-sea-q31mv3l4p8xg49zs.jpg', 1, 'teste', 'teste'),
(3, '37072225663539d52af61.png', 1, 'teste', 'teste');
...
INSERT INTO `quarto` (`id_quarto`, `nome`, `descricao`, `qtde_adulto`, `qtde_crianca`, `preco`, `status`) VALUES
(1, 'Quarto Luxuoso', 'Quarto grande com vista para o mar com suite, acomodando 3 adultos e 2 crianças armário e filtro ', 3, 1, '90.0000', 'T');
...
--
-- Índices de tabela `config_quarto`
--
ALTER TABLE `config_quarto`
...
--
-- AUTO_INCREMENT de tabela `config_quarto`
--
ALTER TABLE `config_quarto`
...
--
ALTER TABLE `foto_quarto`
  MODIFY `id_foto_quarto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
