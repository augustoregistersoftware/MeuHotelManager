...
--
-- Host: 127.0.0.1
-- Tempo de geração: 17/05/2024 às 14:06
...
--
-- Estrutura para tabela `foto_principal_quarto`
--

CREATE TABLE `foto_principal_quarto` (
...
--
-- Índices de tabela `foto_principal_quarto`
--
ALTER TABLE `foto_principal_quarto`
...
--
-- AUTO_INCREMENT de tabela `foto_principal_quarto`
--
ALTER TABLE `foto_principal_quarto`
